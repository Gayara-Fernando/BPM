...
forecasting_steps = 7
path_to_precessed_dfs = 'data/BLAR_ready_dfs/block_0105/'
# sub_image_number = 0
n_features = 33
nchains = 4
...
sub_image_files = ['block_0105_df_' + str(i) +'.csv' for i in range(3000, 3072)]
sub_image_numbers = np.arange(3000, 3072)
...
with concurrent.futures.ProcessPoolExecutor(max_workers=20) as executor:
    all_dfs = list(tqdm(executor.map(run_model, range(72)), total = 72))