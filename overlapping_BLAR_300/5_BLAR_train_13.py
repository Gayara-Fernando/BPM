...
forecasting_steps = 7
path_to_precessed_dfs = 'data/BLAR_ready_dfs/block_0206/'
# sub_image_number = 0
n_features = 33
nchains = 4
...
sub_image_files = ['block_0206_df_' + str(i) +'.csv' for i in range(1300, 1376)]
sub_image_numbers = np.arange(1300, 1376)
...
with concurrent.futures.ProcessPoolExecutor(max_workers=20) as executor:
    all_dfs = list(tqdm(executor.map(run_model, range(76)), total = 76))