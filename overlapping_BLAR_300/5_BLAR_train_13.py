...
forecasting_steps = 7
path_to_precessed_dfs = 'data/BLAR_ready_dfs/block_0306/'
# sub_image_number = 0
n_features = 33
nchains = 4
figure_folder_path = 'data/BLAR_implementation/Block_0306/figures'
forecasts_folder_path = 'data/BLAR_implementation/Block_0306/forecasted_counts'
# fig, ax = plt.subplots(1, 1, figsize=(10, 5))
# fig_ax = (fig, ax)

# let's limit the dfs to 10 for now
sub_image_files = ['block_0306_df_' + str(i) +'.csv' for i in range(1300, 1376)]
