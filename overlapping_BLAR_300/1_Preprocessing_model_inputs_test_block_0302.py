...
block_0103 = '../../../Spring_2024/S_lab_TasselNet/Block_14_TN/Block_14_images_and_xml'
...
np.save("data/test_input_sub_images/test_data_blk_0302.npy", stack_block_0103)

# sanity check
load_test_blk_0103 = np.load("data/test_input_sub_images/test_data_blk_0302.npy")
