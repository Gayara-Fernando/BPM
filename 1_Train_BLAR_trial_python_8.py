...
forecasting_steps = 7
path_to_precessed_dfs = 'data/BLAR_ready_dfs/model_1/block_0302/'
# sub_image_number = 0
n_features = 33
nchains = 4
figure_folder_path = 'data/BLAR_implementation/Block_0302/figures'
forecasts_folder_path = 'data/BLAR_implementation/Block_0302/forecasted_counts'
# fig, ax = plt.subplots(1, 1, figsize=(10, 5))
# fig_ax = (fig, ax)

# let's limit the dfs to 10 for now
sub_image_files = ['block_0302_df_' + str(i) +'.csv' for i in range(800, 910)]
