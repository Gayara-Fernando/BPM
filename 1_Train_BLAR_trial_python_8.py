...
forecasting_steps = 7
path_to_precessed_dfs = 'data/BLAR_ready_dfs/model_1/block_0106/'
# sub_image_number = 0
n_features = 33
nchains = 4
figure_folder_path = 'data/BLAR_implementation/Block_0106/figures'
forecasts_folder_path = 'data/BLAR_implementation/Block_0106/forecasted_counts'
# fig, ax = plt.subplots(1, 1, figsize=(10, 5))
# fig_ax = (fig, ax)

# let's limit the dfs to 10 for now
sub_image_files = ['block_0106_df_' + str(i) +'.csv' for i in range(800, 910)]
sub_image_numbers = np.arange(800, 910)
...
with concurrent.futures.ProcessPoolExecutor(max_workers=20) as executor:
    all_dfs = list(tqdm(executor.map(run_model, range(110)), total = 110))